...
function renderStatus(status: 'In Progress' | 'Unassigned') {
...
export const columns: GridColDef[] = [
	{ field: 'internalTeams', headerName: 'Internal Teams', flex: 1.5, minWidth: 200 },
	{
		field: 'status',
		headerName: 'Status',
		flex: 0.5,
...
export const rows: GridRowsProp = [
	{
		id: 1,
		internalTeams: 'Team Alpha',
		status: 'In Progress',
		fileName: "InvChris",
		createdAt: "5/11/2024",
		dataSource: 18.5,
		numOfErros: '2m 15s',
		profToUpdate: "Lauren Y.",
	},
	{
		id: 2,
		internalTeams: 'Team Alpha',
		...
		dataSource: 18.5,
		numOfErros: '2m 15s',
		profToUpdate: "Laura Y",
	},
	{
		id: 3,
		internalTeams: 'Team Delta',
		status: 'In Progress',
		fileName: "W1_Review",
		createdAt: "3/01/2023",
		dataSource: 18.5,
		numOfErros: '2m 15s',
		profToUpdate: "Josie A.",
	},
	{
		id: 4,
		internalTeams: 'Team Epsilon',
		status: 'In Progress',
		fileName: "Risk_Ana",
		createdAt: "7/13/2023",
		dataSource: 18.5,
		numOfErros: '2m 15s',
		profToUpdate: "Honey G.",
	},
	{
		id: 5,
		internalTeams: 'Team Beta',
		status: 'Unassigned',
		fileName: "F22_W1_Pres",
		createdAt: "7/24/2023",
		dataSource: 18.5,
		numOfErros: '2m 15s',
		profToUpdate: "Darcy G",
	},
	/*
	{
	  id: 6,
